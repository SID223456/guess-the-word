...
function check()
{
var getinput = document.getElementById("input_check_box").value;
var answer = getinput.toLowerCase();
...
if(answer == word)
{
    if(answer_turn == "player1")
    {
        ...
        document.getElementById("player_1_score").innerHTML = player1_score;
        console.log("player 1 score was increased to " + player1_score)
    }
    ...
    else
    {
        ...
        document.getElementById("player_2_score").innerHTML = player2_score;
        console.log("player 2 score was increased to " + player2_score);
    }    
}
